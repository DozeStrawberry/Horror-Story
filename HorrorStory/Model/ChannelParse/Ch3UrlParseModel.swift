...
//取得影片協議
protocol Ch3ModelDelegate {
    func ch3VideosFetched(_ videos: [VideoModel])
}

class Ch3UrlParseModel {
    
    var delegate: Ch3ModelDelegate?
    
    func getVideos() {
        
        // Create a URL object
        let url = URL(string: Constants.S03_API_URL)
            ...
            do {
                ...
                if response.items != nil {
                    ...
                    DispatchQueue.main.async {
                        ...
                        self.delegate?.ch3VideosFetched(newVideos)
                    }
                }
